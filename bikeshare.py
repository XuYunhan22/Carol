...
def get_filters():
    ...
    while True:
     city = input('q1/3：which city do you want to know? chicago, new york city or washington').lower()
     if city in city_option:
      break
    
    while True:
     month = input('q2/3: which month do you want to know? all, january, february, ... , june').lower()
     if month in month_option:
      break
    
    while True:
     day = input('q3/3: which day do you want to know ? all, monday, tuesday, ... sunday').lower()
...
def user_stats(df):
    ...
    try:
     ...
     print('>>>The city you choose do not have /Birth Year/ data:')
    finally:
     pass
